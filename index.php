<?php include 'include_header.php';?>
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
        <a href="downloads" id="download-button" class="btn-large green waves-effect waves-light">Get Started</a>
      </div>
      <br><br>
      ...
      <div class="row">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Thanks to the new core, cSploit will be easily portable.
              <br /><br />
            Basically it can run on any UNIX-based system, but for now only Andorid is supported. When I reach a beta-state version I will consider working on iOS, OSX, GTK+ and QT.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Please <a href="donate">donate</a> to cSploit to support our efforts and resources. Thank you!
            <br /><br />
